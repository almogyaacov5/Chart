...
public class PriceAlertReceiver extends BroadcastReceiver {
    ...
    private static final String ACTION_CHECK = "com.example.chart.CHECK_PRICE_ALERTS";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        // קריאה חד-פעמית לכל רשימת המעקב
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    float currentPrice = Float.parseFloat(
                            values.getJSONObject(0).getString("close"));

                    if (currentPrice >= stock.alertTargetPrice) {
                        // שלח Notification
                        sendNotification(context, stock.symbol, stock.alertTargetPrice, currentPrice);

                        // עדכן Firebase — alertTriggered = true כדי לא לשלוח שוב
                        watchlistRef.child(stock.symbol)
                                .child("alertTriggered").setValue(true);
                    }
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, CHANNEL_ID)
                ...
                .setStyle(new NotificationCompat.BigTextStyle()
                        .bigText(String.format(
                                "המניה %s חצתה את מחיר היעד שלך!%nמחיר נוכחי: $%.2f%nמחיר יעד: $%.2f",
